...
ActiveRecord::Schema.define(version: 2020_08_03_084033) do
  ...
  create_table "decidim_hospitalet_surveys_survey_results", id: :serial, force: :cascade do |t|
    ...
    t.index ["decidim_author_id"], name: "index_decidim_hospitalet_surveys_on_author_id"
    t.index ["decidim_feature_id", "decidim_user_id", "decidim_scope_id"], name: "index_unique_user_feaeture_scope_for_surveys", unique: true, where: "(decidim_user_id IS NOT NULL)"
    t.index ["decidim_feature_id"], name: "index_decidim_hospitalet_surveys_on_feature_id"
    t.index ["decidim_scope_id"], name: "index_decidim_hospitalet_surveys_on_scope_id"
    t.index ["decidim_user_id"], name: "index_decidim_hospitalet_surveys_on_user_id"
    t.index ["selected_categories"], name: "index_decidim_hospitalet_surveys_on_categories_ids"
  end
